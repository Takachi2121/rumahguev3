...
<div class="container testi-section px-0 my-5" id="testimoni-section">
    ...
    <div class="label-testi">
        ...
        <p class="text-white fw-semibold mb-0 w-100 text-uppercase testi-huge text-center" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true">testimoni</p>
    </div>
</div>
